  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        else if (role === "seller" || role === "farmer") navigate("/farmer/dashboard")
        else navigate("/")
      } else {
      ...
      <div className="auth-shell">
        <div className="brand-block">
          <div className="brand-icon-wrap">
            <LuSprout className="brand-icon" />
          </div>
          <h1 className="brand-title">Kheti</h1>
          <p className="brand-tagline">Growing together, harvesting success</p>
        </div>

        <div className="auth-panel">
          <div className="panel-header">
            <h2>{isLogin ? "Welcome Back" : "Create Your Account"}</h2>
            <p>{isLogin ? "Sign in to continue your journey" : "Start managing your agri needs"}</p>
          </div>
          ...
          {success && (
            <div className="alert alert-success" role="status">
              <LuCheckCircle className="alert-icon" />
              <span>{success}</span>
          ...
          <div className="social-row">
            ...
            <button className="social-btn fb">
              <svg viewBox="0 0 24 24">
                <path
                  fill="currentColor"
                  d="M24 12.073c0-6.627-5.373-12-12-12S0 5.446 0 12.073C0 18.064 4.388 23.027 10.125 24v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796V24C19.612 23.027 24 18.064 24 12.073z"
                />
              </svg>
              Facebook
            </button>
        ...
        <footer className="auth-footer">
          <span>© {new Date().getFullYear()} Kheti</span>
